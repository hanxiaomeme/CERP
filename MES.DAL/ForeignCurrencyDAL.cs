...
{
    /// <summary>
    /// 数据访问类:foreigncurrency
    /// </summary>
    public partial class ForeignCurrencyDAL
    {
        #region  BasicMethod
        /// <summary>
        /// 是否存在该记录
        ...
        public bool Exists(int i_id)
        {
            ...
            strSql.Append("select count(1) from foreigncurrency");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select i_id,cexch_name,cexch_code,bcal,idec,nerror,iotherused,pubufts ");
            strSql.Append(" FROM foreigncurrency ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" i_id,cexch_name,cexch_code,bcal,idec,nerror,iotherused,pubufts ");
            strSql.Append(" FROM foreigncurrency ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            {
                strSql.Append("order by T.i_id desc");
            }
            strSql.Append(")AS Row, T.*  from foreigncurrency T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "foreigncurrency";
