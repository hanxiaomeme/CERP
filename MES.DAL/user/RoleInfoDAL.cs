...
namespace MES.DAL
{
    ...
    public partial class RoleInfoDAL
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(MES.Model.RoleInfo model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into RoleInfo(");
            strSql.Append("RoleCode,RoleName,cMemo)");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@cMemo", SqlDbType.NVarChar,100)};
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(MES.Model.RoleInfo model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public MES.Model.RoleInfo GetModel(int RoleID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 RoleID,RoleCode,RoleName,cMemo from RoleInfo ");
            strSql.Append(" where RoleID=@RoleID");
            SqlParameter[] parameters = {
					new SqlParameter("@RoleID", SqlDbType.Int,4)
			};
            ...
            MES.Model.RoleInfo model = new MES.Model.RoleInfo();
        ...
        /// 得到一个对象实体
        /// </summary>
        public MES.Model.RoleInfo DataRowToModel(DataRow row)
        {
            MES.Model.RoleInfo model = new MES.Model.RoleInfo();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select RoleID,RoleCode,RoleName,cMemo ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" RoleID,RoleCode,RoleName,cMemo ");
            strSql.Append(" FROM RoleInfo ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
