...
namespace LanyunMES.DAL
{
    ...
    public static class DataTableExtensions
    {
        ...
        public static List<DynamicParameters> ToDapperList(this DataTable table, bool reverse = true, params string[] FilterField)
        {
            var modelList = new List<DynamicParameters>();
    ...
    {
        public static DynamicParameters ToDapperParam(this DataRow row)
        {
            var model = new DynamicParameters();
