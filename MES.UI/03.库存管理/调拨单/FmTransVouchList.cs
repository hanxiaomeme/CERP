...
namespace LanyunMES.UI
{
    ...
    public partial class FmTransVouchList : DevComponents.DotNetBar.OfficeForm, IFView<TransVouchDAL>
    {
        public FmTransVouchList()
        {
            InitializeComponent();
        ...
        private void ShowDetail(object sender, MouseEventArgs e)
        {
            ...
            FmTransVouch frm = new FmTransVouch(guid);
