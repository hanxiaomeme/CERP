...
namespace LanyunMES.UI
{
    ...
    public partial class FmTransVouch : DevComponents.DotNetBar.OfficeForm, IFView<TransVouchDAL>
    {
        private FmTransVouch()
        {
            InitializeComponent();
            ...
            this.txtr_whOut.ButtonCustomClick += RefWareHouse;
            this.txtr_cSourceCode.ButtonCustomClick += RefQmrList;
        }
        ...
        public FmTransVouch(string guid) : this()
        {
            this.guid = guid;
