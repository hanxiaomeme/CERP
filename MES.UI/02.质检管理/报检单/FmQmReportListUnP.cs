...
namespace LanyunMES.UI
{
    ...
    public partial class FmQmReportListUnP : DevComponents.DotNetBar.OfficeForm , IFView<QmReportController>
    {
        public FmQmReportListUnP()
        {
            InitializeComponent();
        ...
        private void Query(object obj, EventArgs e)
        {
            ...
            //默认显示未处理, U8未入库, 已审核
            //cState = 1: 审核 2:关闭
            wheres.Add("QmQty > 0 and QmQty > isnull(haveQmQty,0) ");
        ...
        private void DGX_RowCellStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs e)
        {
            if((bool)DGX.GetRowCellValue(e.RowHandle,"bQualify"))
            {
