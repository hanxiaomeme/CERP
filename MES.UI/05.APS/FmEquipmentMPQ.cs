...
namespace LanyunMES.UI
{
    ...
    public partial class FmEquipmentMPQ : DevComponents.DotNetBar.OfficeForm
    {
        public FmEquipmentMPQ()
        {
            InitializeComponent();
            this.txt_cInvCodeS.ButtonCustomClick += RefEquipment;
            this.txt_cInvCodeE.ButtonCustomClick += RefEquipment;
        }
        ...
        private void RefEquipment(object sender, EventArgs e)
        {
            ...
            {
                (sender as TextBox).Text = frm.Results[0].cEQCode;
            }
        }
